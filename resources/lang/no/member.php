<?php
  return [
    ...
    "education" => "Utdanning",
    "education_all" => "alle",
    "only_with_education" => "Bare med utdannelse",
    "only_without_education" => "Bare uten utdannelse",
    ...
    'about' => 'Om',
    'customer-membership' => 'Kunde siden',
    ...
    'my-plan' => 'Planene mine',
    'calendar' => 'Min kalender',
    'user' => 'Bruker',
    'booked-date' => 'Bestilt dato',
    'start-time' => 'Starttid',
    'end-time' => 'Sluttid',
    'paid' => 'Betalt',
    'customer' => 'Kunde'
