...
<div class="full-cart solve feature-service">
    <div class="container">
        <div class="col-12 d-flex align-items-center flex-column">
            @if($lang == 'en')
                <h2>{!! $consultantsAndServicesPageData->services->en_title !!}</h2>
            @else
                <h2>{!! $consultantsAndServicesPageData->services->no_title !!}</h2>
            @endif
            <div class="feature-service-groups my-5">
                <?php $count = count($consultantsAndServicesPageData->services->arr); ?>
                @foreach($consultantsAndServicesPageData->services->arr as $key => $item)
                    @if($key == 0)
